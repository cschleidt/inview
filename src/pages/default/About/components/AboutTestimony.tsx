...
const aboutTestimonyData = [
  {
    quote: 'When i\'m in Dubai, I can check my investments on Inview in real time, it\'s quick, free and easy to use!',
    image: Omar,
    person: 'Omar from Dubai',
  },
  {
    quote: 'Inview is awesome, it puts the the fine ass in finance, I wish people told me about using it sooner!',
    image: Gabe,
    person: 'Babe Levin',
  },
  {
    quote: 'I refered my friend Nick to Inview, it\'s been a week I\'m still waiting on the referral bonus that I was promised. ',
    image: Arisa,
    person: 'Queen Arisa',
  },
  {
