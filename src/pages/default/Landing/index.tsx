  ...
  return (
    <div className="landingContainer">
      <div className="landingCenter">
        ...
        {/* <h2 className='landingTag'>Welcome to Inview</h2> */}
        <h3>
        ...
        tracking your finances. We at Inview decided to change this.
        </h3>
        <h3>
        Inview is a place for you
        ...
        suit your investment needs. Invest smart, track with Inview.
        </h3>
